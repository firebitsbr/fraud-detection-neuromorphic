"""
**Descrição:** Estratégias de otimização de custos em nuvem e auto-scaling.
...
"""
    ...
    def calculate_savings(
        ...
        - Savings: $4,380/mo (60%)
        """
        cost_without = self.max_replicas * hourly_cost_per_pod * hours_per_month
        avg_pods = self.min_replicas + (self.max_replicas - self.min_replicas) * avg_utilization
        cost_with = avg_pods * hourly_cost_per_pod * hours_per_month
...
class SpotInstanceManager:
    ...
    - Diversify instance types (reduce interruption)
    ...
    def calculate_spot_savings(
        ...
        - Savings: $2,014/mo (90%)
        """
        cost_on_demand = on_demand_price * hours_per_month
        cost_spot = spot_price * hours_per_month
    ...
    def create_spot_fleet_config(
        ...
        for instance_type in instance_types:
            ...
            config['LaunchSpecifications'].append(launch_spec)
...
class EdgeDeploymentOptimizer:
    ...
    - Process locally → reduce cloud API calls
    ...
    def __init__(self):
        ...
        self.cloud_api_cost_per_1k = 0.10  # $0.10 per 1000 calls
    ...
    def calculate_edge_savings(
        ...
        - 80% processed at edge
        - Cloud: 10M * $0.10/1k = $1,000/mo
        - Edge: 2M * $0.10/1k = $200/mo + $2,500/device amortized
        - Savings: $800/mo
        """
        cloud_only_cost = (monthly_transactions / 1000) * self.cloud_api_cost_per_1k
        
        cloud_transactions = monthly_transactions * (1 - edge_processing_ratio)
        cloud_cost = (cloud_transactions / 1000) * self.cloud_api_cost_per_1k
        
        # Amortize edge device over 36 months
        edge_device_monthly = self.edge_device_cost / 36
        
        total_edge_cost = cloud_cost + edge_device_monthly
        
        savings = cloud_only_cost - total_edge_cost
        savings_percent = (savings / cloud_only_cost) * 100
...
class CostMonitor:
    ...
    Features:
    - Track costs by service/environment
    - Budget alerts
    - Anomaly detection
    ...
    def get_cost_breakdown(
        ...
        try:
            ...
            # Categorize
            compute_cost = costs.get('Amazon Elastic Compute Cloud', 0)
            storage_cost = costs.get('Amazon Simple Storage Service', 0)
            network_cost = costs.get('Amazon Virtual Private Cloud', 0)
